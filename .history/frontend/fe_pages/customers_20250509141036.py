...
#                                 with col2:
#                                     st.markdown(f"<div style='height:${col1.height};'></div>", unsafe_allow_html=True)
...
def customer_page():
    ...
    # Edit customer modal
    if st.session_state.get('show_edit_modal', False) and 'edit_customer' in st.session_state:
        show_edit_modal()
