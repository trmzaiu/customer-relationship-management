...
def customer_page():
                ...
                if df.empty:
                    ...
                    if st.button("🚀 Process Import", type="primary", use_container_width=True):
                        if col_map["name"] == "-- Select --" or col_map["email"] == "-- Select --":
                            ...
                            # Pre-check all emails to reduce API calls
                            if duplicate_action == "Skip":
                                ...
                                existing_emails = set()
                                for i in range(0, len(all_emails), 100):  # Check in batches of 100
    ...
    with tab3:
        ...
        try:
            # Use a cache for the lookup as well
            ...
            if customer_data:
                ...
                with update_tab:
                    # Use form for update to reduce reruns
