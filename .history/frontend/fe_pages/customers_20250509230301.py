                ...
                if customer_data:
                    ...
                    with update_tab:
                        with st.form(key="update_customer_form"):
                            ...
                            update_submit = st.button(label="💾 Save Changes", use_container_width=True, type="primary")
                    ...
                    with delete_tab:
                        ...
                        if st.button("🗑️ Delete Customer", key="delete", use_container_width=True, type="primary"):
                            try:
