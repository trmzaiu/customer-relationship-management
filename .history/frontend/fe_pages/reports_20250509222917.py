    ...
    with tab1:
        ...
        with col2:
            ...
            fig_bar.update_layout(
                margin=dict(l=50, r=50, t=80, b=80),  # Điều chỉnh lề (left, right, top, bottom)
                autosize=True,                         # Tự động điều chỉnh kích thước
                height=500,                            # Chiều cao cố định (có thể điều chỉnh)
                yaxis=dict(
                    automargin=True,                   # Tự động căn lề trục y
                    title_standoff=25                  # Khoảng cách tiêu đề trục
                )
            )
