        ...
        if 'customer_data' in st.session_state:
            ...
            if not data:
                ...
                if view_type == "Table":
                    ...
                    st.markdown("### Actions")
                    if len(df) > 0:  # Check if there are any customers to select
                        ...
                        st.info("No customers available to select.")
            ...
            if st.button("➕ Create Customer", use_container_width=True):
                ...
                if not name or not email:
                    ...
                    if res.status_code == 201:
                        ...
                        new_id = response_data.get("customer_id") or response_data.get("_id")
