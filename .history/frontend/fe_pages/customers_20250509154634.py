        ...
        if 'customer_data' in st.session_state:
            ...
            if not data:
                ...
                if view_type == "Table":
                    ...
                    # Ensure page_number is always an integer and within valid range
                    ...
                    with col2:
                        # Page navigation with buttons instead of JavaScript
                    ...
                    paginated_data = data[start_idx:min(end_idx, len(data))]
