        ...
        if st.button("🔍 Find Customer", key="find_customer", use_container_width=True):
            try:
                ...
                if res.ok:
                    ...
                    with delete_tab:
            # Khởi tạo biến theo dõi trạng thái trong session_state
            ...
            # Sử dụng on_click để gọi callback khi nút được nhấn
            delete_button = st.button("🗑️ Delete Customer", key="delete", use_container_width=True, on_click=on_delete_click)
            
            # Hiển thị thông báo nếu đã bấm nút
                ...
                if confirm_delete != "DELETE":
                    ...
                    try:
                        ...
                        if res.status_code == 200:
                            ...
                            # Reset trạng thái trước khi rerun
                            st.session_state.delete_button_clicked = False
